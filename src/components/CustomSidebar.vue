...
<template>
              ...
              <ul class="list-none p-0 m-0 overflow-hidden">
                ...
                <li>
                  <a v-ripple class="flex items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                    ...
                    <span class="inline-flex items-center justify-center ml-auto bg-primary border-circle" style="min-width: 1.5rem; height: 1.5rem">3</span>
                  </a>
                </li>
                <li>
                  <a v-ripple class="flex items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
  ...
  >
    <Button
        class="border-textPrimary text-textPrimary bg-transparent"
        icon="pi pi-bars"
